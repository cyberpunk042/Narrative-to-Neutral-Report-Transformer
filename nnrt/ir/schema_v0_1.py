...
class SegmentTransform(BaseModel):
    ...
    policy_rule_id: str | None = Field(None, description="ID of the policy rule that triggered this")
...
class Segment(BaseModel):
    ...
    source_line: int | None = Field(None, description="Line number if available")
...
class Entity(BaseModel):
    ...
    extracted_identifiers: list[ExtractedIdentifier] | None = Field(
        None, description="Optional extracted identifiers"
    )

    # V5: When/how the entity participated
    participation: Participation | None = Field(None, description="Incident/post-incident/mentioned")

    # V6: Direct badge linkage for officers
    badge_number: str | None = Field(None, description="Badge number if officer")
    ...
    invalid_actor_reason: str | None = Field(
        None,
    ...
    name_detection_source: str | None = Field(
        None,
...
class Event(BaseModel):
    ...
    actor_id: str | None = Field(None, description="Entity performing action")
    target_id: str | None = Field(None, description="Entity receiving action")
    temporal_marker: str | None = Field(None, description="Time reference")

    # V5: Resolved labels for rendering (Actor/Action/Target schema)
    actor_label: str | None = Field(None, description="Resolved actor name")
    action_verb: str | None = Field(None, description="The action verb")
    target_label: str | None = Field(None, description="Resolved target name")
    target_object: str | None = Field(None, description="Non-entity target (e.g., 'the door')")
    ...
    neutralized_description: str | None = Field(
        None,
    ...
    actor_resolution_method: str | None = Field(
        None,
...
class SpeechAct(BaseModel):
    ...
    id: str
    type: SpeechActType
    speaker_id: str | None = None  # Entity ID
    ...
    speaker_label: str | None = Field(None, description="Human-readable speaker name")
    ...
    raw_text: str | None = Field(None, description="Original text including quotes")
    ...
    speaker_resolution_method: str | None = Field(
        None,
        description="How resolved: 'pattern', 'context', 'coreference', 'default'"
    )
    speaker_validation: str | None = Field(
        None,
...
class UncertaintyMarker(BaseModel):
    ...
    text: str | None = Field(None, description="The specific text causing uncertainty")
    description: str
...
class Mention(BaseModel):
    ...
    gender: str | None = Field(None, description="he/she/they for pronouns")
    number: str | None = Field(None, description="singular/plural")
...
class StatementGroup(BaseModel):
    ...
    primary_entity_id: str | None = Field(
        None,
...
class TimelineEntry(BaseModel):
    ...
    event_id: str | None = Field(None, description="Link to Event")
    statement_id: str | None = Field(None, description="Link to AtomicStatement")
    group_id: str | None = Field(None, description="Link to StatementGroup")

    # V6: Enhanced temporal information
    temporal_expression_id: str | None = Field(
        None,
    ...
    estimated_minutes_from_start: int | None = Field(
        None,
...
class TransformResult(BaseModel):
    ...
    # Output
    rendered_text: str | None = Field(None, description="Final rendered output")
