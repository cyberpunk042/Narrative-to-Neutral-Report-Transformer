...
from nnrt.ir.schema_v0_1 import Entity, Event
...
def _result_to_event(
    ...
    def find_entity(mention: str) -> Entity | None:
    ...
    def resolve_pronoun(pronoun: str, source_sentence: str) -> Entity | None:
        """
    ...
    " ".join(formatted_parts) if formatted_parts else result.description
